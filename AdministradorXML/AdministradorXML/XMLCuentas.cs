        ...
        private void guardarButton_Click(object sender, EventArgs e)
        {
          ...
          int nivel = 1;
             try
            {
                ...
                {
                    connection.Open();
                    String queryXML = "SELECT c.codigoAgrupador, a.ACNT_CODE , a.DESCR, b.ANL_CODE as sub, bb.ANL_CODE as natur FROM [" + Properties.Settings.Default.sunDatabase + "].[dbo].[" + Properties.Settings.Default.sunUnidadDeNegocio + "_ACNT] a INNER JOIN  [" + Properties.Settings.Default.sunDatabase + "].[dbo].[" + Properties.Settings.Default.sunUnidadDeNegocio + "_ACNT_ANL_CAT] b on b.ACNT_CODE = a.ACNT_CODE INNER JOIN [" + Properties.Settings.Default.databaseFiscal + "].[dbo].[codigoAgrupadorCuentaSunplus] c on c.ACNT_CODE COLLATE SQL_Latin1_General_CP1_CI_AS  = a.ACNT_CODE INNER JOIN  [" + Properties.Settings.Default.sunDatabase + "].[dbo].[" + Properties.Settings.Default.sunUnidadDeNegocio + "_ACNT_ANL_CAT] bb on bb.ACNT_CODE = a.ACNT_CODE WHERE b.ANL_CAT_ID = 12 AND bb.ANL_CAT_ID = 14";
